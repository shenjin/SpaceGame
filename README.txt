...
Images: [Screenshot](http://i.imgur.com/iTsWNi9.png)
...
Note, my turing game relies on turing, which is only available on windows operating systems!
**********************************************************************************************
...
-Overall performance improvements (a lot smoother than before)
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
2/7/14
-Implemented adaptive fuel (as you progress in the game, the amount of gas given for each
 fuel collected is also increased)
	-Thinking of increasing actual amount of fuel with a floor(ln()) function rather
	 than increasing the value of fuel.
...
Power ups: slow-speed, increase-speed, etc
